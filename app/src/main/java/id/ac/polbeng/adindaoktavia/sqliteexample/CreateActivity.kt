...
import id.ac.polbeng.adindaoktavia.sqliteexample.databinding.ActivityCreateBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSimpan.setOnClickListener {
            ...
            if (nim.isEmpty() || name.isEmpty() || age.isEmpty()) {
                Toast.makeText(this, "Silakan masukan data NIM, nama, dan umur!", Toast.LENGTH_SHORT).show()
